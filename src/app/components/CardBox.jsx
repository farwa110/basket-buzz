...
//   // FIXED: do not calculate discount again here
//   const handleAdd = (item) => {
...
//             <ul className="text-gray-800 divide-y divide-gray-300">
//               {cart.map((item) => (
//                 <li key={item.id} className="py-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6">
//                   <div className="flex items-center gap-4">
//                     {/* Product image */}
//                     <img src={item.image} alt={item.title} className="w-20 h-20 object-contain rounded-lg bg-gray-100 p-2 border" />

//                     <div className="flex flex-col">
//                       <span className="font-medium text-lg">{item.title}</span>

//                       <div className="flex items-center mt-3 border-2 border-yellow-400 rounded-full px-4 py-1 gap-4 w-fit justify-center">
//                         {item.quantity > 1 ? (
//                           <button onClick={() => updateQty(item.id, item.quantity - 1)} className="text-xl text-gray-700 font-bold">
//                             -
//                           </button>
...
//                   <div className="font-semibold whitespace-nowrap text-lg">{(item.price * item.quantity).toFixed(2)} kr</div>
//                 </li>
//               ))}
//             </ul>
