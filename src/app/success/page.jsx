...
export default function SuccessPage() {
  return (
    ...
    <main className="min-h-[calc(100vh-140px)] flex items-center justify-center px-6 sm:px-4 py-8">
      {/* <div className="rounded-2xl p-8 sm:p-12 flex flex-col items-center text-center animate-fade-in-up bg-white shadow-xl border border-gray-200"> */}
      <div className="w-full  rounded-2xl p-8 sm:p-12 flex flex-col items-center text-center animate-fade-in-up bg-white shadow-xl border border-gray-200">
        ...
        <p className="text-gray-500 text-base sm:text-lg leading-relaxed max-w-xl mx-auto">Tak for din bestilling. Din betaling er gennemført, og vi er gået i gang med at behandle din ordre. Du vil modtage en bekræftelse hurtigst muligt.</p>
